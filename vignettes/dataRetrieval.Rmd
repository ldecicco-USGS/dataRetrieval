...
Retrieves water use data from USGS Water Use Data for the Nation.  See <https://water.usgs.gov/nwaa-data> for more information.  

```{r eval=FALSE}
allegheny <- read_waterdata_use_data(location = "countyCd:42003",
