...
```{python}
#| eval: false
agency_codes, md = waterdata.get_reference_table("agency-codes")
aquifer_codes, md = waterdata.get_reference_table("aquifer-codes")
aquifer_types, md = waterdata.get_reference_table("aquifer-types")
...
counties, md1 = waterdata.get_reference_table("counties")
states, md1 = waterdata.get_reference_table("states")
```
...
## waterdata.get_combined_metadata {.smaller .scrollable}
