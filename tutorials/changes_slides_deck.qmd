...
## Discrete data censoring {.smaller}
...
qw_data_slim <- qw_data |>
  ...
  mutate(
    nwis_value = if_else(DL_cond != "", DL_val, Result_Measure),
...
* [Daily Statistics API](https://doi-usgs.github.io/dataRetrieval/articles/daily_data_statistics.html)

* [Updated National Groundwater Monitoring Location Network](https://api.waterdata.usgs.gov/ngwmn/ogcapi/collections)

* [HASP](https://doi-usgs.github.io/HASP/)
